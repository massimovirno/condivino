...
INSERT INTO `utente` 
(`username`,         `password`, `nome`,      `cognome`,  `via`,             `CAP`,    `citta`,     `email`,               `sesso`,  `data_nascita`, `codice_fiscale`, `partita_iva`, `telefono`, `codice_attivazione`, `stato` ) VALUES
...
('nikolatesla',      'tesla',    'Nikola',    'Tesla',     '5th Avenue',     '10024',  'New York',  'niktes@elettric.com',     'M',              '',               '',            '',         '',           '12345678', 'attivo'),
('serafinocicerone', 'cicerone', 'Serafino',  'Cicerone',  'Via Croce 1',    '67010',  'L''Aquila', 'sc@prof.aquila.it',       'M',              '',               '',            '',         '',           '12345678', 'attivo');
...
(`locationID`, `citta`,   `indirizzo`             ) VALUES
...
(`cartacreditoID`,  `nome_titolare`, `cognome_titolare`, `data_scadenza`, `ccv`) VALUES
...
(`commentoID`, `testo`,                      `voto`, `vinoID`) VALUES
(           1, 'Nella media',                     6,        1),
(           2, 'Pessimo',                         3,        2),
(           3, 'Eccellente da bere di nuovo',     9,        3);
...
INSERT INTO `evento` 
(`eventoID`, `nome`,            `data_chiusura`,       `posti`, `descBreve`,                                                    `descrizione`,                                                                  `prezzo`, `categoria`, `foto`,       `pubblicato`, `vinoID`, `locationID`,  `utenteID`      ) VALUES
(         1, 'Cena a casa mia', '2015-09-01 20:00:00',      10, 'Cena leggera a casa mia con cous cous e contorni di verdure.', 'Il menu prevede un cous cous con melanzane e zucchine. Cortorno di peperoni.',       10, 'casa',      'foto01.jpg',            1,        1,            1,  'massimovirno'  ),  
(         2, 'BBQ in giardino', '2015-09-03 21:00:00',       5, 'Brace con bistecche e salsicce',                               'Brace nel giardino con carni e bruschette.',                                         25, 'giardino',  'foto02.jpg',            2,        2,            1,  'antoniomartone');
...
CREATE TABLE IF NOT EXISTS `eventopartecipante` (
  ...
  `partecipanteID` 			varchar(20) DEFAULT NULL,
  `eventoID`     			int(13)         NOT NULL
...
(`eventoPartecipanteID`,`pagato`, `partecipanteID`,   `eventoID`) VALUES
(                     1,    NULL, 'antoniomartone',            1),
(                     2,       0, 'serafinocicerone',          1),
(                     3,       0, 'nikolatesla',               2),
(                     4,       0, 'massimovirno',              2),
(                     6,       1, 'massimovirno',              2),
(                    16,       1, 'massimovirno',              1),
...
ALTER TABLE `cartacredito`
  ADD PRIMARY KEY 		 (`cartacreditoID`),
  ADD KEY `Utente`       (`utenteID`);
...
ALTER TABLE `eventopartecipante`
  ADD PRIMARY KEY        (`eventopartecipanteID`), 
  ADD KEY `Evento`       (`eventoID`), 
  ADD KEY `Partecipante` (`partecipanteID`);
...
--
ALTER TABLE `commento`
  MODIFY `commentoID` 				int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `evento`
--
ALTER TABLE `evento`
  MODIFY `eventoID`   				int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `eventopartecipante`
--
ALTER TABLE `eventopartecipante`
  MODIFY `eventopartecipanteID` 	int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `location`
--
ALTER TABLE `location`
  MODIFY `locationID` 				int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `vino`
--
ALTER TABLE `vino`
  MODIFY `vinoID` 					int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `cartacredito`
ADD CONSTRAINT `cartacredito_utente`   			FOREIGN KEY (`utenteID`)   	    REFERENCES `utente`   (`username`);

--
-- Limiti per la tabella `commento`
--
ALTER TABLE `commento`
ADD CONSTRAINT `commento_vino`   				FOREIGN KEY (`vinoID`)          REFERENCES `vino`     (`vinoID`);

--
-- Limiti per la tabella `evento`
--
ALTER TABLE `evento`
ADD CONSTRAINT `evento_vino`     				FOREIGN KEY (`vinoID`)          REFERENCES `vino`     (`vinoID`),
ADD CONSTRAINT `evento_utente`   				FOREIGN KEY (`utenteID`)   	    REFERENCES `utente`   (`username`),
ADD CONSTRAINT `evento_location` 				FOREIGN KEY (`locationID`)      REFERENCES `location` (`locationID`);

--
-- Limiti per la tabella `eventopartecipante`
--
ALTER TABLE `eventopartecipante`
ADD CONSTRAINT `eventopartecipante_evento`       FOREIGN KEY (`eventoID`)       REFERENCES `evento` (`eventoID`),
ADD CONSTRAINT `eventopartecipante_partecipante` FOREIGN KEY (`partecipanteID`) REFERENCES `utente` (`username`);
