<?php /* Smarty version 2.6.26, created on 2015-09-03 17:46:51
         compiled from evento_dettagli_registrato.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ucfirst', 'evento_dettagli_registrato.tpl', 11, false),array('modifier', 'date_format', 'evento_dettagli_registrato.tpl', 12, false),array('modifier', 'string_format', 'evento_dettagli_registrato.tpl', 16, false),)), $this); ?>
...
?>
 ...
 |</p>
          <p class="details"><b>Posti disponibili:</b> | <?php echo $this->_tpl_vars['dati']['posti']; ?>
...
$this->_sections['j']['loop'] = is_array($_loop=$this->_tpl_vars['dati']['partecipante']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
          <blockquote>
            <p><?php echo $this->_tpl_vars['dati']['partecipante'][$this->_sections['j']['index']]['nome']; ?>
</p>
            <p>voto: <?php echo $this->_tpl_vars['dati']['partecipante'][$this->_sections['j']['index']]['cognome']; ?>
</p>
          </blockquote>
          <?php endfor; endif; ?>
        </div>
