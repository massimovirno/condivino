<?php /* Smarty version 2.6.26, created on 2015-09-05 01:58:27
         compiled from evento_default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'evento_default.tpl', 12, false),array('modifier', 'string_format', 'evento_default.tpl', 19, false),)), $this); ?>
...
?>
            ...
            <div class="content-2col-box">
			  <h1><a href="?controller=evento&task=dettagli&id_evento=<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['nome']; ?>
</a></h1>
              <h5>Vino: <?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['vino']; ?>
</h5>
              <p><img height="120" src="foto/<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['foto']; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['dati'][$this->_sections['i']['index']]['descBreve'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 240, " [...]") : smarty_modifier_truncate($_tmp, 240, " [...]")); ?>
</p>
...
<?php else: ?>-<?php endif; ?></a> | Prezzo: <a href="#"><?php echo ((is_array($_tmp=$this->_tpl_vars['dati'][$this->_sections['i']['index']]['prezzo'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</a> |</p>
