<?php /* Smarty version 2.6.26, created on 2015-09-21 00:16:28
         compiled from creazioneevento_modulo.tpl */ ?>
            ...
            <form method="post" action="index.php">
              ...
              <fieldset><legend>&nbsp;DETTAGLI&nbsp;</legend>
                ...
                <p><label for="categoria" class="left">Categoria:</label>
                   <input type="text" name="categoria" id="categoria" class="field" value="" tabindex="14" /></p>
                <p><label for="foto" class="left">Upload foto:</label>
                   <input type="foto" name="foto" id="foto" class="field" value="" tabindex="15" /></p>
                
                <input type="hidden" name="controller" value="creazioneevento" />
                <input type="hidden" name="task" value="salvaevento" />
                <p><input type="submit" name="submit" id="submit_1" class="button" value="Salva" tabindex="16" /></p>
               </fieldset>
            </form>
          </div>
        </div>
